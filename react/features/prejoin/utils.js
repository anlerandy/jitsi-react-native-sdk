...
exports.hasDisplayName = exports.getCountryFromDialCodeText = exports.getCountryCodeFromPhone = exports.countries = void 0;
exports.countries = [
    { name: 'Afghanistan',
        dialCode: '93',
        code: 'af' },
...
const countriesByCodeMap = exports.countries.reduce((result, country) => {
 ...
 *
 */
const codesByNumbersMap = exports.countries.reduce((result, country) => {
...
exports.getCountryCodeFromPhone = getCountryCodeFromPhone;
/**
 ...
 * @returns {Object}
 */
function getCountryFromDialCodeText(text) {
    return (countriesByCodeMap[text.slice(0, 4)]
        || countriesByCodeMap[text.slice(0, 3)]
        || countriesByCodeMap[text.slice(0, 2)]
        || countriesByCodeMap[text.slice(0, 1)]
        || null);
}
exports.getCountryFromDialCodeText = getCountryFromDialCodeText;
/**
 ...
 * @returns {boolean}
 */
const hasDisplayName = (value) => Boolean(value) && value.trim() !== '';
