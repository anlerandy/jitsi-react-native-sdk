...
const AbstractMuteEveryoneDialog_1 = __importStar(require("../AbstractMuteEveryoneDialog"));
...
class MuteEveryoneDialog extends AbstractMuteEveryoneDialog_1.default {
    ...
    _renderSwitch() {
        return (this.props.exclude.length === 0
            && <react_native_dialog_1.default.Switch label={this.props.t('dialog.moderationAudioLabel')} onValueChange={this._onToggleModeration} value={!this.state.audioModerationEnabled}/>);
    }
    /**
     ...
     */
    render() {
        return (<ConfirmDialog_1.default confirmLabel='dialog.muteParticipantButton' descriptionKey={this.state.content} onSubmit={this._onSubmit} title={this.props.title}>
                {/* @ts-ignore */}
