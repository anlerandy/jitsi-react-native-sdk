...
class GrantModeratorDialog extends AbstractGrantModeratorDialog_1.default {
     ...
     */
    render() {
        return (<ConfirmDialog_1.default descriptionKey={`${this.props.t('dialog.grantModeratorDialog', { participantName: this.props.participantName })}`} onSubmit={this._onSubmit}/>);
    }
}
