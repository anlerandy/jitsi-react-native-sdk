...
const EndMeetingIcon_1 = __importDefault(require("./EndMeetingIcon"));
...
const EndMeetingButton = () => {
    ...
    return (<Button_1.default accessibilityLabel='toolbar.accessibilityLabel.leaveConference' icon={EndMeetingIcon_1.default} labelKey='toolbar.leaveConference' onClick={onSelect} style={styles_1.default.endMeetingButton} type={constants_native_1.BUTTON_TYPES.DESTRUCTIVE}/>);
};
exports.default = EndMeetingButton;
