 ...
 * otherwise.
 */
let CallKit = react_native_1.NativeModules.RNCallKit;
...
// need to RNCallKit.
if (CallKit) {
    const eventEmitter = new react_native_1.NativeEventEmitter(CallKit);
    CallKit = {
        ...CallKit,
        ...
        registerSubscriptions(context, delegate) {
            CallKit.setProviderConfiguration({
                ...
                localizedName: (0, functions_native_1.getName)()
            });
            return [
