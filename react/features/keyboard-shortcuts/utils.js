...
exports.getKeyboardKey = exports.getPriorityFocusedElement = void 0;
/**
...
*/
const getPriorityFocusedElement = () => document.querySelector(`:focus:is(${_elementsBlacklist.join(',')})`);
exports.getPriorityFocusedElement = getPriorityFocusedElement;
/**
