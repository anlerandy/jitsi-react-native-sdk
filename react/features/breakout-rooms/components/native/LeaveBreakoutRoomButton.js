...
const LeaveBreakoutRoomButton = () => {
    ...
    return (<Button_1.default accessibilityLabel='breakoutRooms.actions.leaveBreakoutRoom' labelKey='breakoutRooms.actions.leaveBreakoutRoom' onClick={onLeave} style={styles_1.default.button} type={constants_native_1.BUTTON_TYPES.DESTRUCTIVE}/>);
};
exports.default = LeaveBreakoutRoomButton;
