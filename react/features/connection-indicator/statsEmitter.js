...
const statsEmitter = {
    ...
    startListeningForStats(conference) {
        conference.on(lib_jitsi_meet_1.JitsiConnectionQualityEvents.LOCAL_STATS_UPDATED, (stats) => this._onStatsUpdated(conference.myUserId(), stats));
        conference.on(lib_jitsi_meet_1.JitsiConnectionQualityEvents.REMOTE_STATS_UPDATED, (id, stats) => this._emitStatsUpdate(id, stats));
    },
    /**
    ...
    _onStatsUpdated(localUserId, stats) {
        ...
        lodash_1.default.union(framerateUserIds, resolutionUserIds, codecUserIds)
