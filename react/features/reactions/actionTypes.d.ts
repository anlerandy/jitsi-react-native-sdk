 ...
 * }
 */
export declare const TOGGLE_REACTIONS_VISIBLE = "TOGGLE_REACTIONS_VISIBLE";
/**
 ...
 * }
 */
export declare const ADD_REACTION_BUFFER = "ADD_REACTION_BUFFER";
/**
 ...
 * }
 */
export declare const FLUSH_REACTION_BUFFER = "FLUSH_REACTION_BUFFER";
/**
 ...
 * }
 */
export declare const ADD_REACTION_MESSAGE = "ADD_REACTION_MESSAGE";
/**
 ...
 * }
 */
export declare const SET_REACTION_QUEUE = "SET_REACTION_QUEUE";
/**
 * The type of the action which signals a send reaction to everyone in the conference.
 */
export declare const SEND_REACTIONS = "SEND_REACTIONS";
/**
 * The type of action to adds reactions to the queue.
 */
export declare const PUSH_REACTIONS = "PUSH_REACTIONS";
/**
 * The type of action to display disable notification sounds.
 */
export declare const SHOW_SOUNDS_NOTIFICATION = "SHOW_SOUNDS_NOTIFICATION";
