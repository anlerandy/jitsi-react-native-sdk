...
const AbstractSecurityDialogButton_1 = __importStar(require("../AbstractSecurityDialogButton"));
/**
...
class SecurityDialogButton extends AbstractSecurityDialogButton_1.default {
    ...
    _handleClickSecurityButton() {
        (0, ConferenceNavigationContainerRef_1.navigate)(routes_1.screen.conference.security);
    }
}
