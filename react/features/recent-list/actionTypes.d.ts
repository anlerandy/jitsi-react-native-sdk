 ...
 * }
 */
export declare const DELETE_RECENT_LIST_ENTRY = "DELETE_RECENT_LIST_ENTRY";
/**
 ...
 * @protected
 */
export declare const _STORE_CURRENT_CONFERENCE = "_STORE_CURRENT_CONFERENCE";
/**
 ...
 * @protected
 */
export declare const _UPDATE_CONFERENCE_DURATION = "_UPDATE_CONFERENCE_DURATION";
