 ...
 * @type {string}
 */
export declare const E2EE_OFF_SOUND_ID = "E2EE_OFF_SOUND";
/**
 * The identifier of the sound to be played when e2ee is enabled.
 *
 * @type {string}
 */
export declare const E2EE_ON_SOUND_ID = "E2EE_ON_SOUND";
/**
 * The number of participants after which e2ee maxMode is set to MAX_MODE.ENABLED.
 *
 * @type {integer}
 */
export declare const MAX_MODE_LIMIT = 20;
/**
 ...
 * @type {integer}
 */
export declare const MAX_MODE_THRESHOLD = 5;
export declare const MAX_MODE: {
    /**
