...
const math_1 = require("../../base/util/math");
const RnnoiseProcessor_1 = __importDefault(require("../rnnoise/RnnoiseProcessor"));
/**
...
class NoiseSuppressorWorklet extends AudioWorkletProcessor {
    ...
    constructor() {
         ...
         */
        this._denoiseProcessor = new RnnoiseProcessor_1.default((0, rnnoise_wasm_1.createRNNWasmModuleSync)());
        /**
         ...
         */
        this._circularBufferLength = (0, math_1.leastCommonMultiple)(this._procNodeSampleRate, this._denoiseSampleSize);
