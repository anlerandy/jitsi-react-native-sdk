...
class RnnoiseProcessor {
     ...
     */
    getSampleLength() {
        return exports.RNNOISE_SAMPLE_LENGTH;
    }
    /**
    ...
    processAudioFrame(pcmFrame, shouldDenoise = false) {
        ...
        for (let i = 0; i < exports.RNNOISE_SAMPLE_LENGTH; i++) {
...
exports.default = RnnoiseProcessor;
