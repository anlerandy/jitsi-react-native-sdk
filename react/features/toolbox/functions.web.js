...
const ChatButton_1 = require("../chat/components/web/ChatButton");
const EmbedMeetingButton_1 = require("../embed-meeting/components/EmbedMeetingButton");
const SharedDocumentButton_web_1 = require("../etherpad/components/SharedDocumentButton.web");
const FeedbackButton_web_1 = require("../feedback/components/FeedbackButton.web");
const InviteButton_1 = require("../invite/components/add-people-dialog/web/InviteButton");
const KeyboardShortcutsButton_1 = require("../keyboard-shortcuts/components/web/KeyboardShortcutsButton");
const NoiseSuppressionButton_1 = require("../noise-suppression/components/NoiseSuppressionButton");
const ParticipantsPaneButton_1 = require("../participants-pane/components/web/ParticipantsPaneButton");
const RaiseHandContainerButtons_1 = require("../reactions/components/web/RaiseHandContainerButtons");
const ReactionsMenuButton_1 = require("../reactions/components/web/ReactionsMenuButton");
const LiveStreamButton_1 = require("../recording/components/LiveStream/web/LiveStreamButton");
const RecordButton_1 = require("../recording/components/Recording/web/RecordButton");
const ShareAudioButton_1 = require("../screen-share/components/web/ShareAudioButton");
const functions_3 = require("../screen-share/functions");
const SecurityDialogButton_1 = require("../security/components/security-dialog/web/SecurityDialogButton");
const SettingsButton_1 = require("../settings/components/web/SettingsButton");
const SharedVideoButton_1 = require("../shared-video/components/web/SharedVideoButton");
const SpeakerStatsButton_1 = require("../speaker-stats/components/web/SpeakerStatsButton");
const ClosedCaptionButton_1 = require("../subtitles/components/web/ClosedCaptionButton");
const TileViewButton_1 = require("../video-layout/components/TileViewButton");
const VideoQualityButton_web_1 = require("../video-quality/components/VideoQualityButton.web");
const VideoBackgroundButton_1 = require("../virtual-background/components/VideoBackgroundButton");
const WhiteboardButton_1 = require("../whiteboard/components/web/WhiteboardButton");
const functions_4 = require("../whiteboard/functions");
const DownloadButton_1 = require("./components/DownloadButton");
const HelpButton_1 = require("./components/HelpButton");
const AudioSettingsButton_1 = require("./components/web/AudioSettingsButton");
const CustomOptionButton_1 = require("./components/web/CustomOptionButton");
const FullscreenButton_1 = require("./components/web/FullscreenButton");
const LinkToSalesforceButton_1 = require("./components/web/LinkToSalesforceButton");
const ProfileButton_1 = require("./components/web/ProfileButton");
const ShareDesktopButton_1 = require("./components/web/ShareDesktopButton");
const ToggleCameraButton_1 = require("./components/web/ToggleCameraButton");
const VideoSettingsButton_1 = require("./components/web/VideoSettingsButton");
