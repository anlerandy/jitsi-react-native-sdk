 ...
 */
class DownloadButton extends AbstractButton_1.default {
    constructor() {
        super(...arguments);
        this.accessibilityLabel = 'toolbar.accessibilityLabel.download';
        this.icon = svg_1.IconDownload;
    ...
    _handleClick() {
        ...
        (0, functions_1.sendAnalytics)((0, AnalyticsEvents_1.createToolbarEvent)('download.pressed'));
        (0, openURLInBrowser_1.openURLInBrowser)(_downloadAppsUrl);
    }
}
/**
...
exports.default = (0, functions_2.translate)((0, react_redux_1.connect)(_mapStateToProps)(DownloadButton));
