...
exports.getLocalizedDurationFormatter = exports.getLocalizedDateFormatter = void 0;
const moment_duration_format_1 = require("moment-duration-format");
const i18next_1 = require("./i18next");
const moment = require('moment');
// allows for moment durations to be formatted
(0, moment_duration_format_1.default)(moment);
 ...
 * @returns {Object}
 */
function getLocalizedDateFormatter(dateOrTimeStamp) {
    return moment(dateOrTimeStamp).locale(_getSupportedLocale());
}
exports.getLocalizedDateFormatter = getLocalizedDateFormatter;
/**
 ...
 * @returns {Object}
 */
function getLocalizedDurationFormatter(duration) {
...
exports.getLocalizedDurationFormatter = getLocalizedDurationFormatter;
/**
...
function _getSupportedLocale() {
    const i18nLocale = i18next_1.default.language;
    let supportedLocale;
    if (i18nLocale) {
