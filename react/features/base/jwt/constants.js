...
exports.JWT_VALIDATION_ERRORS = exports.FEATURES_TO_BUTTONS_MAPPING = exports.MEET_FEATURES = void 0;
/**
 * The list of supported meeting features to enable/disable through jwt.
 */
exports.MEET_FEATURES = {
    BRANDING: 'branding',
    CALENDAR: 'calendar',
    FLIP: 'flip',
 ...
 */
exports.FEATURES_TO_BUTTONS_MAPPING = {
    'livestreaming': 'livestreaming',
    'recording': 'recording',
