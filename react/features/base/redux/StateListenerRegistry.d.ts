 ...
 * Immutable!
 */
type Listener = (selection: any, store: IStore, prevSelection: any) => void;
/**
 ...
 */
declare class StateListenerRegistry {
    /**
     ...
     */
    _selectorListeners: Set<SelectorListener>;
    /**
     ...
     * @returns {void}
     */
    register(selector: Selector, listener: Listener, options?: RegistrationOptions): void;
    /**
     ...
     * @returns {void}
     */
    subscribe(store: Store<any, any>): void;
}
declare const _default: StateListenerRegistry;
