...
exports.sanitizeUrl = exports.appendURLHashParam = exports.appendURLParam = exports.getDecodedURI = exports.addHashParamsToURL = exports.urlObjectToString = exports.toURLString = exports.safeDecodeURIComponent = exports.parseURIString = exports.parseStandardURIString = exports.getLocationContextRoot = exports.getBackendSafeRoomName = exports.getBackendSafePath = exports.URI_PROTOCOL_PATTERN = exports.APP_LINK_SCHEME = exports.StatusCode = void 0;
const sanitize_url_1 = require("@braintree/sanitize-url");
const parseURLParams_1 = require("./parseURLParams");
 ...
 */
exports.APP_LINK_SCHEME = 'org.jitsi.meet:';
/**
...
function _fixURIStringScheme(uri) {
    const regex = new RegExp(`${exports.URI_PROTOCOL_PATTERN}+`, 'gi');
 ...
 * @returns {string?}
 */
function getBackendSafePath(path) {
    if (!path) {
        return path;
    }
    return path
...
exports.getBackendSafePath = getBackendSafePath;
/**
 ...
 * @returns {string?}
 */
function getBackendSafeRoomName(room) {
    if (!room) {
        return room;
    }
    /* eslint-disable no-param-reassign */
    ...
    room = (0, strings_1.normalizeNFKC)(room);
...
exports.getBackendSafeRoomName = getBackendSafeRoomName;
/**
 ...
 */
function getLocationContextRoot({ pathname }) {
...
function urlObjectToString(o) {
    ...
    if (!url.host) {
        ...
        if (domain) {
            ...
            // a pathname only.
            _fixURIStringScheme(`${exports.APP_LINK_SCHEME}//${domain}`));
            // authority
            if (host) {
                url.host = host;
 ...
 */
function addHashParamsToURL(url, hashParamsToAdd = {}) {
    const params = (0, parseURLParams_1.parseURLParams)(url);
...
exports.addHashParamsToURL = addHashParamsToURL;
/**
...
exports.getDecodedURI = getDecodedURI;
/**
 ...
 * @returns {string} - The modified url.
 */
function appendURLHashParam(url, name, value) {
    const newUrl = new URL(url);
...
exports.appendURLHashParam = appendURLHashParam;
/**
...
function sanitizeUrl(url) {
    ...
    const result = (0, sanitize_url_1.sanitizeUrl)(urlStr);
