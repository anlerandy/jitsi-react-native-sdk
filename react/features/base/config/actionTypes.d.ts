 ...
 * }
 */
export declare const CONFIG_WILL_LOAD = "CONFIG_WILL_LOAD";
/**
 * The redux action which signals that a configuration (commonly known in Jitsi
 ...
 * }
 */
export declare const LOAD_CONFIG_ERROR = "LOAD_CONFIG_ERROR";
/**
 ...
 * }
 */
export declare const OVERWRITE_CONFIG = "OVERWRITE_CONFIG";
