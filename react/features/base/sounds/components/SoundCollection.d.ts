 ...
 * action.
 */
declare class SoundCollection extends Component<IProps> {
    /**
     ...
     */
    render(): React.CElement<import("../../media/components/AbstractAudio").IProps, Audio>[];
    /**
     ...
     * @returns {void}
     */
    _setRef(soundId: string, element?: AudioElement): void;
}
/**
...
export declare function _mapDispatchToProps(dispatch: IStore['dispatch']): {
     ...
     * @returns {void}
     */
    _addAudioElement(soundId: string, audioElement: AudioElement): void;
    /**
     ...
     * @returns {void}
     */
    _removeAudioElement(soundId: string): void;
};
declare const _default: import("react-redux").ConnectedComponent<typeof SoundCollection, import("react-redux").Omit<React.ClassAttributes<SoundCollection> & IProps, "_addAudioElement" | "_removeAudioElement" | "_sounds">>;
