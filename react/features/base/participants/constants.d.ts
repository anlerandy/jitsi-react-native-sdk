 ...
 * @type {string}
 */
export declare const DEFAULT_AVATAR_RELATIVE_PATH = "images/avatar.png";
/**
 ...
 * @type {string}
 */
export declare const JIGASI_PARTICIPANT_ICON: any;
/**
 ...
 * @type {string}
 */
export declare const LOCAL_PARTICIPANT_DEFAULT_ID = "local";
/**
 * Max length of the display names.
 *
 * @type {string}
 */
export declare const MAX_DISPLAY_NAME_LENGTH = 50;
/**
 ...
 * @type {string}
 */
export declare const PARTICIPANT_JOINED_SOUND_ID = "PARTICIPANT_JOINED_SOUND";
/**
 ...
 * @type {string}
 */
export declare const PARTICIPANT_LEFT_SOUND_ID = "PARTICIPANT_LEFT_SOUND";
/**
 ...
 * @type {string}
 */
export declare const LOWER_HAND_AUDIO_LEVEL = 0.2;
/**
 * Icon URL for the whiteboard participant.
 */
export declare const WHITEBOARD_PARTICIPANT_ICON: any;
