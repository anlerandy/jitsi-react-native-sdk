...
// @ts-expect-error
const helpers_1 = require("../../../../modules/util/helpers");
...
exports.microsoftCalendarApi = {
    ...
    signIn() {
        return (dispatch, getState) => {
            ...
            const signInDeferred = (0, helpers_1.createDeferred)();
            const guids = {
                authState: (0, uuid_1.v4)(),
                authNonce: (0, uuid_1.v4)()
            };
            dispatch((0, actions_web_1.setCalendarAPIAuthState)(guids));
            ...
            function handleAuth({ data }) {
                ...
                dispatch((0, actions_web_1.setCalendarAPIAuthState)({
                    authState: undefined,
    ...
    updateCalendarEvent(id, calendarId, location) {
        return (dispatch, getState) => {
            ...
            return (0, functions_1.getShareInfoText)(getState(), location, true /* use html */)
                .then(text => {
                const client = microsoft_graph_client_1.Client.init({
                    authProvider: done => done(null, token)
                });
...
function getParamsFromHash(url) {
    // @ts-ignore
    const params = (0, parseURLParams_1.parseURLParams)((0, uri_1.parseStandardURIString)(url), true, 'hash');
...
function getValidatedTokenParts(tokenInfo, guids, appId) {
    ...
    return {
        ...
        userDomainType: payload.tid === MS_API_CONFIGURATION.MS_CONSUMER_TENANT
...
client, calendarId, fetchStartDays, fetchEndDays) {
    ...
    const windowsTimeZone = (0, windows_iana_1.findWindows)(ianaTimeZone);
    return client
...
function b64utoutf8(str) {
    ...
    const bytes = base64_js_1.default.toByteArray(s);
