 ...
 * }
 */
export declare const ADD_PENDING_INVITE_REQUEST = "ADD_PENDING_INVITE_REQUEST";
/**
 ...
 * }
 */
export declare const BEGIN_ADD_PEOPLE = "BEGIN_ADD_PEOPLE";
/**
 ...
 * }
 */
export declare const REMOVE_PENDING_INVITE_REQUESTS = "REMOVE_PENDING_INVITE_REQUESTS";
/**
 ...
 * }
 */
export declare const SET_CALLEE_INFO_VISIBLE = "SET_CALLEE_INFO_VISIBLE";
/**
 * The type of redux action to signal that the {@code AddPeopleDialog} should close.
 */
export declare const HIDE_ADD_PEOPLE_DIALOG = "HIDE_ADD_PEOPLE_DIALOG";
/**
 ...
 * }
 */
export declare const UPDATE_DIAL_IN_NUMBERS_FAILED = "UPDATE_DIAL_IN_NUMBERS_FAILED";
/**
 ...
 * }
 */
export declare const UPDATE_DIAL_IN_NUMBERS_SUCCESS = "UPDATE_DIAL_IN_NUMBERS_SUCCESS";
