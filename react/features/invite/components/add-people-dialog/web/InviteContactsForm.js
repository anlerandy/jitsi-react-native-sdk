...
const MultiSelectAutocomplete_1 = require("../../../../base/react/components/web/MultiSelectAutocomplete");
...
const AbstractAddPeopleDialog_1 = require("../AbstractAddPeopleDialog");
const styles = (theme) => {
    return {
        formWrap: {
 ...
 */
class InviteContactsForm extends AbstractAddPeopleDialog_1.default {
    /**
     ...
     */
    render() {
        const { _addPeopleEnabled, _dialOutEnabled, _isVpaas, _sipInviteEnabled, t } = this.props;
        ...
        return (react_1.default.createElement("div", { className: classes.formWrap, onKeyDown: this._onKeyDown },
            react_1.default.createElement(MultiSelectAutocomplete_1.default, { id: 'invite-contacts-input', isDisabled: isMultiSelectDisabled, loadingMessage: t(loadingMessage), noMatchesFound: t(noMatches), onItemSelected: this._onItemSelected, onSelectionChange: this._onSelectionChange, placeholder: placeholder, ref: this._setMultiSelectElement, resourceClient: this._resourceClient, shouldFitContainer: true, shouldFocus: true, showSupportLink: !_isVpaas }),
    ...
    _onItemSelected(item) {
        if (item.item.type === constants_1.INVITE_TYPES.PHONE) {
    ...
    _onSubmit() {
        ...
        this._invite(invitees)
            ...
            .finally(() => this.props.dispatch((0, actions_web_1.hideAddPeopleDialog)()));
    }
    /**
    ...
    _getAvatar(user, className = 'avatar-small') {
        return (react_1.default.createElement(Avatar_1.default, { className: className, size: 32, status: user.status, url: user.avatar }));
    }
    /**
    ...
    _parseQueryResults(response = []) {
        ...
        const userTypes = [constants_1.INVITE_TYPES.USER, constants_1.INVITE_TYPES.VIDEO_ROOM, constants_1.INVITE_TYPES.ROOM];
        ...
        const numbers = response.filter(item => item.type === constants_1.INVITE_TYPES.PHONE);
        ...
        const sipAddresses = response.filter(item => item.type === constants_1.INVITE_TYPES.SIP);
    ...
    _renderFormActions() {
        ...
        return (react_1.default.createElement("div", { className: classes.inviteButtons },
            react_1.default.createElement(Button_1.default, { "aria-label": t('dialog.Cancel'), className: 'invite-button', label: t('dialog.Cancel'), onClick: this._onClearItems, onKeyPress: this._onClearItemsKeyPress, role: 'button', type: constants_any_1.BUTTON_TYPES.SECONDARY }),
            react_1.default.createElement(Button_1.default, { "aria-label": t('addPeople.add'), className: 'invite-button', disabled: this._isAddDisabled(), label: t('addPeople.add'), onClick: this._onSubmit, onKeyPress: this._onSubmitKeyPress, role: 'button' })));
    }
    /**
    ...
    _renderTelephoneIcon() {
        return (react_1.default.createElement(Icon_1.default, { src: svg_1.IconPhoneRinging }));
    }
    /**
...
function _mapStateToProps(state) {
    return {
        ...
        _isVpaas: (0, functions_2.isVpaasMeeting)(state)
    };
}
exports.default = (0, functions_1.translate)((0, react_redux_1.connect)(_mapStateToProps)((0, mui_1.withStyles)(InviteContactsForm, styles)));
