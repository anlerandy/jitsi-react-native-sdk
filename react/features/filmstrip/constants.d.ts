 ...
 */
export declare const SMALL_THUMBNAIL_SIZE = 80;
/**
 * The height of the filmstrip in narrow aspect ratio, or width in wide.
 */
export declare const FILMSTRIP_SIZE: number;
/**
 * The aspect ratio of a tile in tile view.
 */
export declare const TILE_ASPECT_RATIO: number;
/**
 * The aspect ratio of a square tile in tile view.
 */
export declare const SQUARE_TILE_ASPECT_RATIO = 1;
/**
 * Width below which the overflow menu(s) will be displayed as drawer(s).
 */
export declare const DISPLAY_DRAWER_THRESHOLD = 512;
/**
 ...
 */
export declare const ASPECT_RATIO_BREAKPOINT = 500;
/**
 * Minimum height of tile for small screens.
 */
export declare const TILE_MIN_HEIGHT_SMALL = 150;
/**
 * Minimum height of tile for large screens.
 */
export declare const TILE_MIN_HEIGHT_LARGE = 200;
/**
 * Aspect ratio for portrait tiles.
 */
export declare const TILE_PORTRAIT_ASPECT_RATIO: number;
/**
 * The default number of visible tiles for tile view.
 */
export declare const TILE_VIEW_DEFAULT_NUMBER_OF_VISIBLE_TILES = 25;
/**
 * The default number of columns for tile view.
 */
export declare const DEFAULT_MAX_COLUMNS = 5;
/**
 * An extended number of columns for tile view.
 */
export declare const ABSOLUTE_MAX_COLUMNS = 7;
/**
 ...
 * @constant
 */
export declare const DISPLAY_VIDEO = 0;
/**
 ...
 * @constant
 */
export declare const DISPLAY_AVATAR = 1;
/**
 ...
 * @constant
 */
export declare const DISPLAY_MODE_TO_CLASS_NAME: string[];
/**
 * The vertical margin of a tile.
 *
 * @type {number}
 */
export declare const TILE_VERTICAL_MARGIN = 4;
/**
 * The horizontal margin of a tile.
 *
 * @type {number}
 */
export declare const TILE_HORIZONTAL_MARGIN = 4;
/**
 * The horizontal margin of a vertical filmstrip tile container.
 *
 * @type {number}
 */
export declare const TILE_VERTICAL_CONTAINER_HORIZONTAL_MARGIN = 2;
/**
 * The vertical margin of the tile grid container.
 *
 * @type {number}
 */
export declare const TILE_VIEW_GRID_VERTICAL_MARGIN = 14;
/**
 * The horizontal margin of the tile grid container.
 *
 * @type {number}
 */
export declare const TILE_VIEW_GRID_HORIZONTAL_MARGIN = 14;
/**
 * The height of the whole toolbar.
 */
export declare const TOOLBAR_HEIGHT = 72;
/**
 * The height of the whole toolbar.
 */
export declare const TOOLBAR_HEIGHT_MOBILE = 60;
/**
 * The size of the horizontal border of a thumbnail.
 *
 * @type {number}
 */
export declare const STAGE_VIEW_THUMBNAIL_HORIZONTAL_BORDER = 4;
/**
 * The size of the vertical border of a thumbnail.
 *
 * @type {number}
 */
export declare const STAGE_VIEW_THUMBNAIL_VERTICAL_BORDER = 4;
/**
 * The size of the scroll.
 *
 * @type {number}
 */
export declare const SCROLL_SIZE = 7;
/**
 ...
 * @type {number}
 */
export declare const VERTICAL_FILMSTRIP_VERTICAL_MARGIN = 26;
/**
 * The min horizontal space between the thumbnails container and the edges of the window.
 *
 * @type {number}
 */
export declare const VERTICAL_FILMSTRIP_MIN_HORIZONTAL_MARGIN = 10;
/**
 ...
 * @type {number}
 */
export declare const HORIZONTAL_FILMSTRIP_MARGIN = 39;
/**
 * Sets after how many ms to show the thumbnail context menu on long touch on mobile.
 *
 * @type {number}
 */
export declare const SHOW_TOOLBAR_CONTEXT_MENU_AFTER = 600;
/**
 ...
 * @type {number}
 */
export declare const TILE_MARGIN = 10;
/**
 ...
 */
export declare const MAX_ACTIVE_PARTICIPANTS = 6;
/**
 * Top filmstrip default height.
 */
export declare const TOP_FILMSTRIP_HEIGHT = 180;
