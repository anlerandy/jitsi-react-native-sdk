 ...
 * }
 */
export declare const SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_LARGE_VIDEO = "SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_LARGE_VIDEO";
/**
 * The type of (redux) action which sets the maximum video height that should be
 ...
 * }
 */
export declare const SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_SCREEN_SHARING_FILMSTRIP = "SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_SCREEN_SHARING_FILMSTRIP";
/**
 * The type of (redux) action which sets the maximum video height that should be
 ...
 * }
 */
export declare const SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_STAGE_FILMSTRIP = "SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_STAGE_FILMSTRIP";
/**
 * The type of (redux) action which sets the maximum video height that should be
 ...
 * }
 */
export declare const SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_TILE_VIEW = "SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_TILE_VIEW";
/**
 * The type of (redux) action which sets the maximum video height that should be
 ...
 * }
 */
export declare const SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_VERTICAL_FILMSTRIP = "SET_MAX_RECEIVER_VIDEO_QUALITY_FOR_VERTICAL_FILMSTRIP";
/**
 ...
 * }
 */
export declare const SET_PREFERRED_VIDEO_QUALITY = "SET_PREFERRED_VIDEO_QUALITY";
