 ...
 * @augments Component
 */
class AbstractStreamKeyForm extends react_1.Component {
    /**
    ...
    constructor(props) {
        ...
        this._debouncedUpdateValidationErrorVisibility = (0, debounce_1.default)(this._updateValidationErrorVisibility.bind(this), 800, { leading: false });
...
exports.default = AbstractStreamKeyForm;
/**
...
function _mapStateToProps(state) {
    return {
        _liveStreaming: (0, functions_1.getLiveStreaming)(state)
    };
}
