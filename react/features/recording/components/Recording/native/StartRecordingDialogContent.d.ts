...
declare const _default: React.ComponentType<import("react-i18next").Omit<import("react-redux").Omit<React.ClassAttributes<StartRecordingDialogContent> & import("../AbstractStartRecordingDialogContent").IProps, "dispatch" | "_dialogStyles" | "_styles" | "_localRecordingEnabled" | "_canStartTranscribing" | "_hideStorageWarning" | "_isModerator" | "_localRecordingAvailable" | "_localRecordingNoNotification" | "_localRecordingSelfEnabled" | "isVpaas">, keyof import("react-i18next").WithTranslation>>;
